...
module.exports = "h1{\r\n    color: green;\r\n    font-size: 150%;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "p{\r\n    color: blue;\r\n    font-style: oblique;\r\n    font-size: 150%;\r\n    \r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<p>\n  DateTime: {{today | date: 'dd-MMMM-yyyy hh:mm:ss'}}!\n</p>\n"
...
var TimeComponent = /** @class */ (function () {
    function TimeComponent() {
        var _this = this;
        setInterval(function () { _this.today = Date.now(); }, 1000);
    }
...
module.exports = "<div>\n  <input type='text' [(ngModel)] = 'user'>\n  <button (click)='search()'>search</button>\n</div>\n<div *ngIf = 'response'>\n  <p>{{response.name}};</p>\n  <p>{{response.location}};</p>\n  <p>{{response.type}};</p>\n  <p>{{response.login}};</p>\n  \n</div>\n<div>\n  <h1>Create Case</h1>\n  <table style=\"width:100%\">\n      UserId:<input [(ngModel)] = \"username\"><br/><br/>\n      Title:<input [(ngModel)]= \"title\"><br/><br/>\n      Body:<input [(ngModel)] = \"body\"><br/><br/>\n  </table>\n</div>\n<button (click)='save(username,title,body)'>save</button>\n\n"
...
var ViewComponent = /** @class */ (function () {
    ...
    ViewComponent.prototype.search = function () {
        var _this = this;
        var obs = this.http.get('https://api.github.com/users/' + this.user);
        obs.subscribe(function (response) { return _this.response = response; });
        console.log(this.response);
    };
    ViewComponent.prototype.save = function (username, title, body) {
        var _this = this;
        this.data = {
            username: username,
            title: title,
        ...
        var obs = this.http.post('http://jsonplaceholder.typicode.com/posts', (this.data));
        obs.subscribe(function (data) { return console.log(_this.data); });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('request'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], ViewComponent.prototype, "request", void 0);
...
module.exports = __webpack_require__(/*! C:\Users\sjavaji\rest-app\src\main.ts */"./src/main.ts");
